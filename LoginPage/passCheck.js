...
const check = () => {
  ...
  if (input.match(/[a-z]/)) {
    ...
    parent[3].querySelector("span").innerText = "Password does contain a small letter";
    count=count+1;

  } else {
    parent[3].style.color = "red";
    parent[3].querySelector("span").innerText = "Password does not contain a small letter";

  }

  if (input.match(/[^A-Za-z0-9-''/i]/)) {
    parent[4].style.color = "green";
    parent[4].querySelector("span").innerText = "Password does contain a special character";

  } else {
    parent[4].style.color = "red";
    parent[4].querySelector("span").innerText = "Password does not contain a special character";
